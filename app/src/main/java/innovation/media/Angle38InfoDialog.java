...
public class Angle38InfoDialog extends Dialog {
    ...
    public Angle38InfoDialog(Context context) {
        super(context, R.style.Alert_Dialog_Style);
        setContentView(R.layout.angle38_info_dialog_layout);
        mTitle = (TextView) findViewById(R.id.tv_title38);

        mImage3 = (ImageView) findViewById(R.id.image3);
        mImage8 = (ImageView) findViewById(R.id.image8);
        mPositiveBtn = (Button) findViewById(R.id.positiveAngle38Info);
        mNegativeBtn = (Button) findViewById(R.id.negativeAngle38Info);
//        initView(model, info);
