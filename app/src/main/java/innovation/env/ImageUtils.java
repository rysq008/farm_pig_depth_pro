...
public class ImageUtils {
  ...
  static {
    try {
      ...
      LOGGER.i("Lu,ImageUtils_Native library success!!!");
    } catch (UnsatisfiedLinkError e) {
      LOGGER.i("Lu,ImageUtils_Native library not found, native RGB -> YUV conversion may be unavailable.");
    }
  }
   ...
   * @param output InSureCompanyBean pre-allocated array for the ARGB 8:8:8:8 output data.
   ...
   *
   * @param input The array of YUV 4:2:0 input data.
   * @param output InSureCompanyBean pre-allocated array for the RGB 5:6:5 output data.
   * @param width The width of the input image.
   * @param height The height of the input image.
   */
   ...
   * @param output InSureCompanyBean pre-allocated array for the YUV420SP output data.
   * @param width The width of the input image.
   * @param height The height of the input image.
   */
