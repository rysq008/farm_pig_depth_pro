...
public class IDCardValidate {
     ...
     */
    public static String validateIDcardNumber(String idcardNumber, boolean isreturn_AutoCard){
        isNeedReturn_AutoCard=isreturn_AutoCard;
        return validateIDcardNumber(idcardNumber);
    }
    /**
     * 身份证校验
     * @param idcardNumber 需要验证的身份证
     * @return 身份证无误返回传入的身份证号
     */
    public static String validateIDcardNumber(String idcardNumber){
...
//        System.out.println(validateIDcardNumber("50023019920325099x"));
//        System.out.println(validateIDcardNumber("50023019920325099X", true));
//    }
}
