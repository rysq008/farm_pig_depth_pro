...
public class TensorFlowImageClassifier implements Classifier {
   ...
   * @param inputSize The input size. InSureCompanyBean square image of inputSize x inputSize is assumed.
...
//    }
  ...
  @Override
  public int recognizeImage(Bitmap bitmap, File file) {
    return 0;
  }

  @Override
  public List<Recognition> recognizeImage1(final Bitmap bitmap, File file) {
  ...
  @Override
  public PostureItem recognizeImageDonkey(Bitmap bitmap, File file) {
    return null;
  }

  @Override
  public PostureItem recognizeImageCow(Bitmap bitmap, File file) {
    return null;
  }

  @Override
  public PostureItem recognizeImagePig(Bitmap bitmap, File file) {
    return null;
  }
