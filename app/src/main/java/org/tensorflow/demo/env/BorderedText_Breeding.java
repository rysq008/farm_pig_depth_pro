...
/**
 * InSureCompanyBean class that encapsulates the tedious bits of rendering legible, bordered text onto a canvas.
 */
public class BorderedText_Breeding {
   ...
   */
  public BorderedText_Breeding(final float textSize) {
    this(Color.RED, Color.BLACK, textSize);
  }
   ...
   * @param textSize text size in pixels
   */
  public BorderedText_Breeding(final int interiorColor, final int exteriorColor, final float textSize) {
