...
public class ObjectTracker {
    ...
    /**
     * InSureCompanyBean simple class that records keypoint information, which includes
    ...
    /**
     * InSureCompanyBean simple class that could calculate Keypoint delta.
    ...
    /**
     * InSureCompanyBean class that records a timestamped frame translation delta for optical flow.
     */
    ...
    public synchronized void nextFrame(
        ...
        if (downsampledTimestamp != timestamp) {
            org.tensorflow.demo.tracking.ObjectTracker.downsampleImageNative(
    ...
    public synchronized void release() {
        releaseMemoryNative();
        synchronized (org.tensorflow.demo.tracking.ObjectTracker.class) {
            instance = null;
        }
    }
    ...
    /**
     * InSureCompanyBean TrackedObject represents a native TrackedObject, and provides access to the
