...
//
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA) || shouldShowRequestPermissionRationale(PERMISSION_STORAGE)) {
                Toast.makeText(BreedingCameraActivity_pig.this, "Camera AND storage permission are required for this demo", Toast.LENGTH_LONG).show();
            }
    ...
    public BreedingCameraConnectionFragment_pig mFragment = null;

    protected void setFragment() {
        mFragment = BreedingCameraConnectionFragment_pig.newInstance(
                new BreedingCameraConnectionFragment_pig.ConnectionCallback() {
                    @Override
                    public void onPreviewSizeChosen(final Size size, final int rotation) {
                        BreedingCameraActivity_pig.this.onPreviewSizeChosen(size, rotation);
                    }
                },
