...
//        setContentView(R.layout.activity_toubao_cow_info);
        ...
        tv_singleFarmName = findViewById(R.id.tv_singleFarmName);
        ...
        adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, ConstUtils.geInsureTypeCaptions(ANIMAL_TYPE));
...
//        btn_renniu_photo.setEnabled(false);


//        FileUtils.deleteFile(zipFile_image);
        return imgResp;
    }
    ...
    private View.OnClickListener btn_commitClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (SystemClock.elapsedRealtime() - lastClickTime < MIN_CLICK_DELAY_TIME) {
                Toast.makeText(ToubaoCowInfoActivity.this, "正在处理，请勿连续多次点击！", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            //读取用户信息
            SharedPreferences pref_user = ToubaoCowInfoActivity.this.getSharedPreferences(Utils.USERINFO_SHAREFILE, Context.MODE_PRIVATE);
            String username = pref_user.getString("fullname", "");

            if (stringPagetype.contains("toubao")) {
                ...
                query.put("siji", tv_singleFarmName.getText().toString().trim());
                ...
                query.put("level4", tv_singleFarmName.getText().toString().trim());
                query.put("level5", "");


                if (InnApplication.isOfflineMode) {
                    StringBuilder builder = new StringBuilder();
                    mapToJson(query, builder);
                    ...
                    innovation.tuil2.FileUtils.writeDatesToSDCard(jsonFile, jsonString);
                    // TODO: 2018/8/9 压缩大文件
                    ...
                    AlertDialog.Builder innerBuilder = new AlertDialog.Builder(ToubaoCowInfoActivity.this)
                            ...
                            .setNegativeButton("继续录入", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                    Intent intent = new Intent(ToubaoCowInfoActivity.this, DetectorActivity.class);
    ...
    public class AddCowTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success & HttpUtils.INSUR_ADDPIG_URL.equalsIgnoreCase(mUrl)) {
                ...
                if (stringPagetype.indexOf("toubao") > -1) {
// TODO: 2018/8/23 By:LuoLu
                ...
                case 100:
                    if (animalBuildResult.status == 1) {
                        if (animalBuildResult.buildStatus == 1) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(ToubaoCowInfoActivity.this)
                                    .setIcon(R.drawable.cowface)
                                    .setTitle("提示")
    ...
    private Handler mProgressHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 51:
                    mProgressDialog = new ProgressDialog(ToubaoCowInfoActivity.this);
                ...
                case 41:
                    ...
                    AlertDialog.Builder tcaBuilder = new AlertDialog.Builder(ToubaoCowInfoActivity.this)
                            .setIcon(R.drawable.cowface)
                            .setTitle("提示")
                            .setMessage("网络异常！请重试")
                            .setPositiveButton("确定", new DialogInterface.OnClickListener() {
