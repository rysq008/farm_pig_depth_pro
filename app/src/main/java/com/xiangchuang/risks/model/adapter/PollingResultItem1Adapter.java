...
import com.xiangchuang.risks.view.LiPeiActivity;
...
public class PollingResultItem1Adapter extends BaseAdapter {


    private final List<PollingListBean.DataBean.List1Bean.JuanListBeanX> juanList;
    ...
    public PollingResultItem1Adapter(Context context, List<PollingListBean.DataBean.List1Bean.JuanListBeanX> juanList, String sname, String fleg) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.juanname.setText(juanList.get(position).getName());
        viewHolder.polljuan_count.setText(juanList.get(position).getCount() + "");
        ...
        viewHolder.chulan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialogManager.showMessageDialog(context, "提示",sname + "-" + juanList.get(position).getName() + "的猪只头数即将变为0头，确认出栏?", new AlertDialogManager.DialogInterface() {
                    @Override
