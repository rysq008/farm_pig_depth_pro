...
public class UploadThread extends HandlerThread {
    private Logger mLogger = new Logger(UploadThread.class);
...
//                    upload(2);
        ...
        private void upload(int model)
        {
            ...
            {
                zipImagetDir = FarmGlobal.mediaInsureItem.getZipImageDir();//storage/emulated/0/innovation/animal/投保/ZipImage
                zipVideoDir = FarmGlobal.mediaInsureItem.getZipVideoDir();//storage/emulated/0/innovation/animal/投保/ZipVideo
            }
            else if(model == Model.VERIFY.value())
            {
                zipImagetDir = FarmGlobal.mediaPayItem.getZipImageDir();//
//                /sdcard/Android/data/com.farm.innovation.animal_cowface/cache/innovation/animal/理赔/ZipVideo/Time-2018_07_04_115209.zip
//                /storage/emulated/0/Android/data/com.farm.innovation.animal_cowface/cache/innovation/animal/理赔/ZipVideo
                zipVideoDir = FarmGlobal.mediaPayItem.getZipVideoDir();//storage/emulated/0/innovation/animal/投保/ZipVideo
            }
...
//                    namepre = tmpfilename.substring(0, lastindex);
                    ...
                    if (imgResp != null && imgResp.status == HttpRespObject.STATUS_OK) {
                        ...
                        int lib_id = imgResp.libId;
//                        FileUtils2.chageFileName(zipVideoDir, namepre, lib_id);
                    }
                }
            }
