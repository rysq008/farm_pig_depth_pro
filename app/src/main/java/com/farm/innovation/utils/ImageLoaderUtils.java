...
public class ImageLoaderUtils {
    ...
    public static DisplayImageOptions getDefaultOptions() {
        return new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.farm_default_load_image)
                .showImageForEmptyUri(R.drawable.farm_default_load_image)
                .showImageOnFail(R.drawable.farm_default_load_image)
                .cacheInMemory(true)
                .cacheOnDisk(true)
                .build();
    }
