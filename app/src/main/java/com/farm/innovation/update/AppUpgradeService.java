...
public class AppUpgradeService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mNotification.contentView = new RemoteViews(getPackageName(), R.layout.farm_download_notification);
        ...
        mProgressDialog = new ProgressDialog(FarmAppConfig.getActivity());
