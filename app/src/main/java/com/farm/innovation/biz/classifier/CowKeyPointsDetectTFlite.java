...
import static com.farm.innovation.biz.classifier.CowFaceDetectTFlite.srcCowBitmapName;
...
public class CowKeyPointsDetectTFlite implements FarmClassifier {
    private static final Logger sLogger = new Logger(CowKeyPointsDetectTFlite.class);
    ...
    public static FarmClassifier create(
            ...
            throws IOException {
        final CowKeyPointsDetectTFlite d = new CowKeyPointsDetectTFlite();
    ...
    private CowKeyPointsDetectTFlite() {
    }
