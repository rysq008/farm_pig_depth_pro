...
public class ReviewVideoDialog extends Dialog {
    ...
    public void setData() {
        videoList.clear();
        String suff = "";
        int index = FarmGlobal.VIDEO_SUFFIX.indexOf(".");
        if(index < 0)
            suff = FarmGlobal.VIDEO_SUFFIX;
        else
            suff = FarmGlobal.VIDEO_SUFFIX.substring(index+1);
    ...
    private class videoAdapter extends RecyclerView.Adapter<videoAdapter.MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            MyViewHolder myViewHolder = new MyViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.farm_review_video_layout, viewGroup,
                    false));
