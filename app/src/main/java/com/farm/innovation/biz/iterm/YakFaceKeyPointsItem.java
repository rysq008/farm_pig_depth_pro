...
public class YakFaceKeyPointsItem {
    ...
    static YakFaceKeyPointsItem yakFaceKeyPointsItem;
    public static YakFaceKeyPointsItem getInstance() {
        if (yakFaceKeyPointsItem == null) {
            synchronized (YakFaceKeyPointsItem.class) {
                if (yakFaceKeyPointsItem == null) {
                    yakFaceKeyPointsItem = new YakFaceKeyPointsItem();
                }
            }
        }
        return yakFaceKeyPointsItem;
    }

    private YakFaceKeyPointsItem() {
    }
    ...
    public static YakFaceKeyPointsItem getYakFaceKeyPointsItem() {
        return yakFaceKeyPointsItem;
    }

    public static void setYakFaceKeyPointsItem(YakFaceKeyPointsItem yakFaceKeyPointsItem) {
        YakFaceKeyPointsItem.yakFaceKeyPointsItem = yakFaceKeyPointsItem;
    }
}
