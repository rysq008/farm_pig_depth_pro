...
public class InsuranceResultDialog extends Dialog {
    ...
    public InsuranceResultDialog(Context context) {
...
//        btnReturn = findViewById(R.id.btnReturn);
    ...
    {
//        image1.setBackgroundResource(R.drawable.farm_cow_angle2no);
//        image2.setBackgroundResource(R.drawable.farm_cow_angle1no);
//        image3.setBackgroundResource(R.drawable.farm_cow_angle0no);
