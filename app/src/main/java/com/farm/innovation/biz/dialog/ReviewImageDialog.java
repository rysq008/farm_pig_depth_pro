...
import com.farm.innovation.utils.CaptureImageItem;
...
//        });
    ...
    public void setData() {
        imageList.clear();
        String suff = "";
        int index = FarmGlobal.IMAGE_SUFFIX.indexOf(".");
        if(index < 0)
            suff = FarmGlobal.IMAGE_SUFFIX;
        else
            suff = FarmGlobal.IMAGE_SUFFIX.substring(index+1);
    ...
    private class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            MyViewHolder myViewHolder = new MyViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.farm_review_image_layout, viewGroup,
                    false));
            // View view = LayoutInflater.from(mActivity).inflate(R.layout.farm_review_image_layout, viewGroup,false);
...
//        @Override
//        public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
//            MyViewHolder viewHolder = new MyViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.farm_review_image_layout, viewGroup,
//                    false));
//            View view = LayoutInflater.from(mActivity).inflate(R.layout.farm_review_image_layout, viewGroup,false);
//            return viewHolder;
//        }
