...
import com.farm.innovation.biz.iterm.PigFaceKeyPointsItem;
...
public class PigKeyPointsDetectTFlite implements FarmClassifier {
...
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"pigKeyP1",srcPigBitmapName);
            pigKeypointsK1 = true;
...
//            com.farm.innovation.utils.ImageUtils.drawKeypoints(canvasDrawPoints,point5,padSize,"5");
//            com.farm.innovation.utils.ImageUtils.drawKeypoints(canvasDrawPoints,point9,padSize,"9");
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"pigKeyP2",srcPigBitmapName);
            pigKeypointsK2 = true;
        }else if (pointsExists[9] == 0 && pointsExists[3] + pointsExists[5] == 2){
//            com.farm.innovation.utils.ImageUtils.drawKeypoints(canvasDrawPoints,point3,padSize,"3");
//            com.farm.innovation.utils.ImageUtils.drawKeypoints(canvasDrawPoints,point5,padSize,"5");
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"pigKeyP3",srcPigBitmapName);
            pigKeypointsK3 = true;
        } else{
//            if (points != null) {
...
//
//            }
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"pigKeyP10",srcPigBitmapName);
