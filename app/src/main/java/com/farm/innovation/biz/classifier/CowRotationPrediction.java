...
public class CowRotationPrediction implements FarmClassifier {
    private static final Logger sLogger = new Logger(CowRotationPrediction.class);
    ...
    public static FarmClassifier create(
            ...
            throws IOException {
        final CowRotationPrediction d = new CowRotationPrediction();
...
//        sLogger.i(srcYakBitmapName + "predictRotZ %f:" + predictRotZ );
        ...
        if(FarmGlobal.model == Model.BUILD.value()){
            ...
            cowPredictAngleType = Rot2AngleType.getCowAngleTypeLiPei(predictRotX,
                    predictRotY);
        }
...
//                    "；totalTime：" + (dTime+(System.currentTimeMillis() - aTime)+kTime));
            ...
            contenType += CowFaceDetectTFlite.srcCowBitmapName + "; ";
