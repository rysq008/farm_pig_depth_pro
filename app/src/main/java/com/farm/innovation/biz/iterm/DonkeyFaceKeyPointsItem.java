...
public class DonkeyFaceKeyPointsItem {
    ...
    static DonkeyFaceKeyPointsItem donkeyFaceKeyPointsItem;
    public static DonkeyFaceKeyPointsItem getInstance() {
        if (donkeyFaceKeyPointsItem == null) {
            synchronized (DonkeyFaceKeyPointsItem.class) {
                if (donkeyFaceKeyPointsItem == null) {
                     donkeyFaceKeyPointsItem = new DonkeyFaceKeyPointsItem();
                }
            }
        }
        return donkeyFaceKeyPointsItem;
    }

    private DonkeyFaceKeyPointsItem() {
    }
    ...
    public static DonkeyFaceKeyPointsItem getDonkeyFaceKeyPointsItem() {
        return donkeyFaceKeyPointsItem;
    }

    public static void setDonkeyFaceKeyPointsItem(DonkeyFaceKeyPointsItem donkeyFaceKeyPointsItem) {
        DonkeyFaceKeyPointsItem.donkeyFaceKeyPointsItem = donkeyFaceKeyPointsItem;
    }
