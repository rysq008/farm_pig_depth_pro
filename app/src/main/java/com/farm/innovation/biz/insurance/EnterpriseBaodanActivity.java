...
//                }
    ...
    private void photograph(String imageType) {
        ...
        takeIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(EnterpriseBaodanActivity.this, "com.xiangchuangtec.luolu.animalcounter.provider", tempFile));
