 ...
 */
public class DonkeyRotationPrediction implements FarmClassifier {
    private static final Logger sLogger = new Logger(DonkeyRotationPrediction.class);
    ...
    public static FarmClassifier create(
            ...
            throws IOException {
        final DonkeyRotationPrediction d = new DonkeyRotationPrediction();
    ...
    private DonkeyRotationPrediction() {}
...
//        sLogger.i("croppedBitmap width:" + croppedBitmap.getWidth());
        ...
        float quantization = 126;
        double scale = 0.0132853;
        float predictRotX;
        float predictRotY;
        float predictRotZ;
        ...
        predictRotX = (float) ((charsOutRotation0 - quantization) * scale);
        predictRotY = (float) ((charsOutRotation1 - quantization) * scale);
        predictRotZ = (float) ((charsOutRotation2 - quantization) * scale);
//        sLogger.i("charsOutRotation0 %f:" + predictRotX);
//        sLogger.i("charsOutRotation1 %f:" + predictRotY);
//        sLogger.i("charsOutRotation2 %f:" + predictRotZ);
...
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotP1",srcDonkeyBitmapName);
        }else if (donkeyPredictAngleType == 2){
            // draw rotation
//            Canvas canvasDrawRecognition = new Canvas(padBitmap);
//            com.farm.innovation.utils.ImageUtils.drawText(canvasDrawRecognition,
//                    "角度:"+donkeyPredictAngleType, 10,30,
//                    "X:"+String.valueOf(predictRotX * rotScale),10,60,
//                    "Y:"+String.valueOf(predictRotY * rotScale),10,90);
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotP2",srcDonkeyBitmapName);
        }else if (donkeyPredictAngleType == 3){
            // draw rotation
//            Canvas canvasDrawRecognition = new Canvas(padBitmap);
//            com.farm.innovation.utils.ImageUtils.drawText(canvasDrawRecognition,
//                    "角度:"+donkeyPredictAngleType,10,30,
//                    "X:"+String.valueOf(predictRotX * rotScale),10,60,
//                    "Y:"+String.valueOf(predictRotY * rotScale),10,90);
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotP3",srcDonkeyBitmapName);
        }else {
            // draw rotation
//            Canvas canvasDrawRecognition = new Canvas(padBitmap);
//            com.farm.innovation.utils.ImageUtils.drawText(canvasDrawRecognition,
...
//                    "X:"+String.valueOf(predictRotX * rotScale),10,60,
//                    "Y:"+String.valueOf(predictRotY * rotScale),10,90);
//            com.farm.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotOther",srcDonkeyBitmapName);
            //角度不是左中右的保存信息
