...
public class ItemView extends RelativeLayout {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (typedArray != null && typedArray.getIndexCount() > 0) {
            ...
            setLineHeight(mTopLine, typedArray.getDimensionPixelSize(R.styleable.ItemView_top_line_height, UIUtils.dp2px(getContext(), 0.5f)));
            ...
            setLineHeight(mBottomLine, typedArray.getDimensionPixelSize(R.styleable.ItemView_bottom_line_height, UIUtils.dp2px(getContext(), 0.5f)));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int resultHeight = UIUtils.dp2px(getContext(), UIUtils.DEFAULT_VIEW_HEIGHT);
        switch (measureHeightMode) {
            case MeasureSpec.UNSPECIFIED:
                UIUtils.dp2px(getContext(), UIUtils.DEFAULT_VIEW_HEIGHT);
                UIUtils.setDefaultRootViewSize(getContext(), mRootView);
                break;
        ...
        setMeasuredDimension(UIUtils.getWidthPixels(getContext()), resultHeight);
    }
