...
//    public static final String BASENEW =  "http://47.92.167.61:8081/nongxian2/app/";
    ...
    public static final String preTimesFlag = "preTimesFlag";
    ...
    public static String PICTURE_OCR = BASENEW + "accessTokenRecord/pictureOcr";
...
//    public static final String SHEDETAIL = "http://47.92.167.61:8081/numberCheck/app/sheDetail";
    ...
    //获取所有猪种类
    public static String PIG_TYPE_ALL = BASENEW + "ftnShe/pigTypeAll";
    //添加猪舍
    public static String ADD_PIG_HOUSE = BASENEW + "ftnShe/addPigHouse";
    //养殖场详情
    public static String ENDETAIL = BASENEW + "ftnEnDetail";
    //补测重列表
    public static String GET_PAY_LIST = BASENEW + "getPayList";
    //猪舍列表
    public static String PIG_HOUSE_LIST = BASENEW + "ftnShe/pigHouseList";
    //获取离线数据
//    public static String ENLIST_OFFLINE = BASENEW + "ftnEnList_OffLine";
    //获取养殖场列表全部
    public static String ENLIST_OFFLINE = BASENEW + "ftnSecond/enListNew";
    //获取中支、县支公司
    public static String DEPT_BY_LEVEL_LIST = BASENEW + "ftnSecond/deptByLevelList";
    //获取预理赔列表
    public static String PRE_LIPEI_LIST = BASENEW + "ftnSecond/preLipeiList";
    //获取理赔信息
    public static String LIPEI_LIST = BASENEW + "ftnSecond/lipeiList";
    //关于我们
    public static String ABOUTUS = BASENEW + "ftnSecond/aboutInfo";
    //获取投保数量
    public static String BUBBLE_DATA = BASENEW + "ftnSecond/bubbleDataStatistic";
    //判断预理赔是否录制视频接口
    public static String JUDGE_RECORD_VIDEO = BASENEW + "ftnSecond/judgeRecordVideo";
    //上传离线数据
    public static String FTN_LIPEI_OFFLINE = BASENEW + "payment/ftnLipeiOffLine";
...
//获取保单列表
        ...
        PIG_TYPE_ALL = BASENEW + "ftnShe/pigTypeAll";
        ADD_PIG_HOUSE = BASENEW + "ftnShe/addPigHouse";
        ENDETAIL = BASENEW + "ftnEnDetail";
        GET_PAY_LIST = BASENEW + "getPayList";

        PIG_HOUSE_LIST = BASENEW + "ftnShe/pigHouseList";

//        ENLIST_OFFLINE = BASENEW + "ftnEnList_OffLine";
        ENLIST_OFFLINE = BASENEW + "ftnSecond/enListNew";
        DEPT_BY_LEVEL_LIST = BASENEW + "ftnSecond/deptByLevelList";

        FTN_LIPEI_OFFLINE = BASENEW + "payment/ftnLipeiOffLine";
        PICTURE_OCR = BASENEW + "accessTokenRecord/pictureOcr";

        PRE_LIPEI_LIST = BASENEW + "ftnSecond/preLipeiList";
        //获取理赔信息
        LIPEI_LIST = BASENEW + "ftnSecond/lipeiList";
        //关于我们
        ABOUTUS = BASENEW + "ftnSecond/aboutInfo";
        //获取投保数量
        BUBBLE_DATA = BASENEW + "ftnSecond/bubbleDataStatistic";
        //判断预理赔是否录制视频接口
        JUDGE_RECORD_VIDEO = BASENEW + "ftnSecond/judgeRecordVideo";
    }
}
