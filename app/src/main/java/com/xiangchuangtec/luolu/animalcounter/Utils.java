...
//                            }
    ...
    public static float setAttributes(Context context, Paint rectPaint, TextPaint textPaint) {
        Resources resources = context.getResources();

//        rectPaint.setColor(resources.getColor(R.color.colorRect));
//        luolu
        rectPaint.setColor(Color.GREEN);
        rectPaint.setStrokeWidth(resources.getDimensionPixelSize(R.dimen.dp_2));
        rectPaint.setStyle(Paint.Style.STROKE);

        float textSize = resources.getDimensionPixelSize(R.dimen.sp_14);
    ...
    public static Boolean notUpToStandard(long timestamp, int pastSeconds) {
        return (getDuring(timestamp) / 1000 / (DetectorActivity_pig.type1Count + DetectorActivity_pig.type2Count + DetectorActivity_pig.type3Count + 1)) > pastSeconds;
    }
    ...
    public static void getThreshold() {
        ...
        NewFaceDetectTFlite.MIN_CONFIDENCE = Float.parseFloat(thresholdList.getPigtoubao());
    ...
    public static void setLowThreshold() {
        ...
        NewFaceDetectTFlite.MIN_CONFIDENCE = Float.parseFloat(thresholdList.getPiglipei2());
    }
